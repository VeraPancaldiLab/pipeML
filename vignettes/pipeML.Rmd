...
res = pipeML::compute_features.training.ML(as.data.frame(t(counts_train)), traitData_train$Response, trait.positive = "R", 
                                           ...
                                           ncores = 2, return = F, fold_construction_fun = prepare_TFs_folds)
```
...
res = pipeML::compute_features.training.ML(as.data.frame(t(counts_train)), traitData_train$Response, trait.positive = "R", 
                                           metric = "AUROC", stack = F, k_folds = 5, n_rep = 10, LODO = F, 
                                           ncores = 2, return = F, fold_construction_fun = prepare_TFs_folds,
                                           fold_construction_args_fixed = list(TF.collection = "CollecTRI", min_targets_size = 5, tfs.pruned = FALSE))
```
