...
Both `compute_features.training.ML()` and `compute_shap_values()` accept a `fold_models_dir` argument (default: `"Results/fold_models"`). Set both to the same path to ensure the files written during CV are found during SHAP computation:
