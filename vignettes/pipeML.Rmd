...
`pipeML` is built on top of existing frameworks and makes extensive use of the R packages `caret`, `parnsip`, `tidymodels`, `parsnip` and `censored`. If you use `pipeML` in your work, please cite our package along with these foundational packages. 
